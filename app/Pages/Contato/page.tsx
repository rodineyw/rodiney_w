...
export default function Contato() {
 return (
  <div id="contato" className="flex flex-col h-screen items-center justify-center">
   ...
   bg-slate-400 dark:bg-slate-800 items-center justify-center gap-2 rounded-full px-8 py-2"><RxEnvelopeClosed className="text-4xl" /> rodineyw@yahoo.com.br</a>

    <a target="_blank" href="https://www.linkedin.com/in/rodineyw/" className="flex w-48 text-xl bg-slate-400 dark:bg-slate-800 items-center justify-center gap-2 rounded-full px-4 py-2"><RxLinkedinLogo className="text-4xl" /> LinkedIn</a>
   </div>
  </div>
 )
}