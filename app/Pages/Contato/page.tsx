 ...
 return (
  <div id="contato" className="flex flex-col h-screen items-center justify-center">
   ...
   <div className="flex flex-col mt-8 text-slate-400 justify-center items-center gap-4">
    ...
    <a href="mailto:rodineyw@yahoo.com.br" className="flex w-48 text-xl bg-slate-800 items-center justify-center gap-2 rounded-full px-4 py-2"><RxLinkedinLogo className="text-4xl" /> LinkedIn</a>
   </div>
  </div>
 )
}