 ...
 return (
  <div className='sticky top-0 w-full'>
   <div className="relative">
    <div
     className="absolute w-full -inset-2 rounded-lg bg-gradient-to-bl from-teal-600 via-purple-600 to-purple-600 opacity-50 blur-2xl"
    ></div>

    <div className="absolute flex w-full h-20 items-center justify-between border-b border-zinc-700 bg-zinc-800 bg-opacity-50 text-slate-300">
